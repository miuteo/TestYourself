...
public class AnswerResourceIntTest {
    ...
    private static final Boolean DEFAULT_IS_CORECT = false;
    private static final Boolean UPDATED_IS_CORECT = true;
    ...
    public void createAnswer() throws Exception {
        ...
        assertThat(testAnswer.getVariant()).isEqualTo(DEFAULT_VARIANT);
        assertThat(testAnswer.isIsCorect()).isEqualTo(DEFAULT_IS_CORECT);
    ...
    @Test
    @Transactional
    public void checkVariantIsRequired() throws Exception {
    ...
    public void getAllAnswers() throws Exception {
        ...
        restAnswerMockMvc.perform(get("/api/answers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].isCorect").value(hasItem(DEFAULT_IS_CORECT.booleanValue())))
    ...
    public void getAnswer() throws Exception {
        ...
        restAnswerMockMvc.perform(get("/api/answers/{id}", answer.getId()))
            ...
            .andExpect(jsonPath("$.isCorect").value(DEFAULT_IS_CORECT.booleanValue()))
    ...
    public void updateAnswer() throws Exception {
        ...
        Answer testAnswer = answerList.get(answerList.size() - 1);
        assertThat(testAnswer.getVariant()).isEqualTo(UPDATED_VARIANT);
        assertThat(testAnswer.isIsCorect()).isEqualTo(UPDATED_IS_CORECT);
